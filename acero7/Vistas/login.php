...
<title>Iniciar sesión | Acero Gym</title>
...
<div class="auth-page">
  ...
  <div class="auth-card">
    <div class="auth-card__form">
      <p class="auth-card__eyebrow">Acero Gym</p>
      <h1 class="auth-card__title">Iniciar<br>Sesión</h1>

      <?php if (isset($_GET['registrado'])): ?>
        <p class="auth-msg auth-msg--ok">¡Registro completado! Ahora podés iniciar sesión.</p>
      <?php endif; ?>

      <?php if (isset($error)): ?>
        <p class="auth-msg auth-msg--error"><?= htmlspecialchars($error) ?></p>
      <?php endif; ?>

      <form action="index.php?action=procesar_login" method="POST">
        <div class="field">
          <input class="field__input" type="text" name="usuario_o_email" placeholder="Usuario o email" required>
      ...
      <p class="auth-card__foot">¿No tenés cuenta? <a href="index.php?action=registro">Registrate aquí</a></p>
    </div>
